...
class DiffDock:
    ...
    # def __init__(self, score_model_args, confidence_args):
    ...
    def update(self, inp, file, ligand_inp, ligand_file, n_it, n_samples, actual_steps, no_final_step_noise,
                       score_model_args, confidence_args):
        ...
        from diffdock.datasets.process_mols import (
...
@stub.function(mounts=[modal.Mount.from_local_dir("./", remote_path="/root/diffdock")])
def get_args():
    from argparse import ArgumentParser, Namespace, FileType
    import yaml
    ...
    with open(f"./diffdock/workdir/paper_score_model/model_parameters.yml") as f:
        score_model_args = Namespace(**yaml.full_load(f))

    with open(f"./diffdock/workdir/paper_confidence_model/model_parameters.yml") as f:
        confidence_args = Namespace(**yaml.full_load(f))
    return score_model_args, confidence_args
